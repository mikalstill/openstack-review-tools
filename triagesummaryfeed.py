...
# Take triage summaries and turn them into a feed
...
if __name__ == '__main__':
    ...
    feedutils.SendTriagers(cursor, initial_size)
    ...
    for username in showusers:
        ...
        for i in range(initial_size):
            ...
            cursor.execute('select * from bugtriagesummary where username="%s" and '
                           'day=date(%s);'
                           %(username, timestamp))
